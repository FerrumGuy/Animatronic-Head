...
class Eyes {
  public:
    Eyes(int left_leftRightPin, int left_upDownPin, int left_eyeLidPin,int right_leftRightPin, int right_upDownPin, int right_eyeLidPin, int jaw_jawPin); 
  ...
  private:
    ...
    int jawOpenDuration;  //random time to keep jaw open before chomping
