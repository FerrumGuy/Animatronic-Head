...
void Eyes::home() {
  ...
  jaw.jawServo.setEaseTo(jaw.jawClose, speed);
  ...
  jaw.jawServo.setEaseTo(jaw.jawOpen, speed);
...
void Eyes::chomp(int closeSpeed, int openSpeed, int closeDelay) {
  jaw.jawServo.setEaseTo(jaw.jawClose, closeSpeed);
  ...
  jaw.jawServo.setEaseTo(jaw.jawOpen, openSpeed);
